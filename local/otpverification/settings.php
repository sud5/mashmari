...
// General settings.
$settings = new admin_settingpage('local_otpverification', new lang_string('pluginname', 'local_otpverification'));
$ADMIN->add('localplugins', $settings);

// Checkbox for enabling teacher to create new form.
$settings->add(new admin_setting_configcheckbox(
    "local_otpverification/enable_sandbox",
    new lang_string("enable_sandbox", "local_otpverification"),
    new lang_string("des-enable_sandbox", "local_otpverification"),
    false
));
